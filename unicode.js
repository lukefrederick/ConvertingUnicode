...
// let sumCodePoints = firstCodePoint + thirdCodePoint;
...
let swappedString = String.fromCharCode(inputString2.charCodeAt(5)) + inputString2.slice(1, 5) + String.fromCharCode(inputString2.charCodeAt(0)); // Your code here
